...
The following tools and libs are used in the construction of the project: <br>
...
4. Finally, access http://localhost:3000 (the port ':3000' is subjected to changes) on your favorite browser
